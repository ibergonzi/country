...
/* @var $searchModel frontend\models\MensPersonasSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Mensajes sobre Personas';
...
<div class="mens-personas-index">
	...
	$columns = [
            ...
            [
				'attribute'=>'estado',  
				'value'=>function ($model) { return MensPersonas::getEstados($model->estado);},
				'filter'=>MensPersonas::getEstados()				         
            ],
	...
	if (\Yii::$app->user->can('exportarMensPersonas')) {        
