...
$this->title = Yii::t('app', 'Autorizantes por U.F.');
...
$(document).ready(function() {
    ...
    $("#modalmensaje").on("hidden.bs.modal", function (e) {
		$("#gridAutorizantes").yiiGridView("applyFilter");
	});	
           ...
           ['class' => 'kartik\grid\ActionColumn',
             'header'=>Html::a('<span class="glyphicon glyphicon-plus-sign"></span>',
                                ...
                                ['class' => 'btn-sm btn-primary',
                                 'title' => Yii::t('app', 'Alta de autorizante'),]),
 			 'template' => \Yii::$app->user->can('borrarAutorizante')?'{comentario} {mensajeP} {delete}':'{comentario} {mensajeP}',      
			 'buttons' => [
