...
/**
 * CortesEnergiaSearch represents the model behind the search form about `frontend\models\CortesEnergia`.
 */
class CortesEnergiaSearch extends CortesEnergia
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $dataProvider = new ActiveDataProvider([
            ...
            'sort' => ['defaultOrder' => ['hora_desde' => SORT_DESC,],
