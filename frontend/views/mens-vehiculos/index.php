...
/* @var $searchModel frontend\models\MensVehiculosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Mensajes sobre Vehículos';
...
?>
<div class="mens-vehiculos-index">
	...
	$columns = [
           ...
           [
				'attribute'=>'estado',  
				'value'=>function ($model) { return MensVehiculos::getEstados($model->estado);},
				'filter'=>MensVehiculos::getEstados()				         
            ],
	...
	if (\Yii::$app->user->can('exportarMensVehiculos')) {        
