...
return [
    ...
    'PDF export generated by kartik-v/yii2-grid extension' => 'Exportación a PDF',
    'PDF' => 'PDF',
    'Page' => 'Página',
    ...
    'Resize table columns just like a spreadsheet by dragging the column edges.' => 'Cambie el tamaño de las columnas arrastrando los bordes de las mismas.',
    ...
    'There are {totalCount} records. Are you sure you want to display them all?' => 'Hay {totalCount} registros. Está seguro de querer mostrar todo?',
    'Update' => 'Actualizar',
    'View' => 'Ver',
    'Yii2 Grid Export (PDF)' => 'Barrio Miraflores - Funes Hill',
    'export' => 'exportar',
    'grid-export' => 'exportar-cuadrícula',
    'krajee, grid, export, yii2-grid, pdf' => 'krajee, cuadrícula, exportar, yii2-grid, pdf',
    '© Krajee Yii2 Extensions' => '© Barrio Miraflores - Funes Hill',
];
